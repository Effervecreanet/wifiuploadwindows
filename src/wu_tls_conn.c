...
static int
tls_recv_add_data_to_extra(int s_clt, int received[10], SecBuffer secBufferIn[4]) {
...
static int
tls_recv_first_buffer(int s_clt, int received[10], SecBuffer secBufferIn[4]) {
...
static void
is_extradata_in(SecBuffer secBufferIn[4]) {
	int i;
