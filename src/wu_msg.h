...
enum idmsg {
	...
	ERR_MSG_CANNOT_OPEN_CERT_STORE,
	ERR_MSG_CRYPTENCODEOBJECTEX_FAILED,
	ERR_MSG_CREATE_CERT,
	ERR_MSG_ADD_CERT,
	ERR_MSG_CRYPTACQUIRECONTEXT,
	ERR_MSG_GENKEY,
	ERR_MSG_CERTSTRTONAMEA,
	ERR_MSG_FILETIMETOSYSTEMTIME,
	ERR_MSG_ACQUIRECREDENTIALSHANDLE,
