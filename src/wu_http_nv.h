...
#define HTTP_HEADER_SERVER_VALUE        "wifiupload/5.53"
#define HTTP_HEADER_CONNECTION_VALUE    "Keep-Alive"
#define HTTP_HEADER_KEEP_ALIVE_VALUE    "timeout=32, max=512"
...
#define HEADER_MAX_SIZE       1999
#define HEADER_NV_MAX_SIZE    24
#define HEADER_NAME_MAX_SIZE  32 
#define HEADER_VALUE_MAX_SIZE 256

#define REQUEST_LINE_METHOD_MAX_SIZE 5
#define REQUEST_LINE_RESOURCE_MAX_SIZE 64
