				...
				if (_stat(logpath, &statbuff) && _mkdir(logpath)) {
					...
					if (systime.wMonth < 10) {
						if (systime.wDay < 10) {
							...
							ZeroMemory(loghttps_filename, sizeof("loghttps_19700101.txt"));
							sprintf_s(loghttps_filename, sizeof("loghttps_19700101.txt"), "loghttps_%i0%i0%i.txt", systime.wYear, systime.wMonth, systime.wDay);
							...
							ZeroMemory(loghttps_filename, sizeof("loghttps_19700101.txt"));
							sprintf_s(loghttps_filename, sizeof("loghttps_19700101.txt"), "loghttps_%i0%i%i.txt", systime.wYear, systime.wMonth, systime.wDay);
						}
					}
						...
						ZeroMemory(loghttps_filename, sizeof("loghttps_19700101.txt"));
						sprintf_s(loghttps_filename, sizeof("loghttps_19700101.txt"), "loghttps_%i%i0%i.txt", systime.wYear, systime.wMonth, systime.wDay);
					}
					else {
						sprintf_s(wDayStr, 3, "%i", systime.wDay);
						strcat_s(logpath, 512, "\\");
						...
						ZeroMemory(loghttps_filename, sizeof("loghttps_19700101.txt"));
						sprintf_s(loghttps_filename, sizeof("loghttps_19700101.txt"), "loghttps_%i%i%i.txt", systime.wYear, systime.wMonth, systime.wDay);
					}
